...
wishlist_content.addEventListener("touchend", e => {
    WStopDrag(e)
})

wishlist_content.addEventListener("touchstart", e => {
    WdragStarted(e)
})

wishlist_content.addEventListener("touchmove", e => {
    WDragging(e)
})

wishlist_content.addEventListener("mouseleave", e => {
    WStopDrag(e)
})
